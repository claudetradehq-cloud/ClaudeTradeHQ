...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-neon-orange text-black hover:bg-neon-orangeBright shadow-glow-orange",
        outline:
          "border border-border bg-transparent text-foreground hover:border-neon-orange/60 hover:bg-card/60",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost: "hover:bg-card/60 text-foreground",
        accent:
          "bg-neon-blue text-black hover:bg-neon-blueBright shadow-glow-blue",
        destructive:
